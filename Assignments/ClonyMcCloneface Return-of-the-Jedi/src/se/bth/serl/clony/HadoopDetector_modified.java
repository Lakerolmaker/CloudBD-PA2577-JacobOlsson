...
public class HadoopDetector_modified extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
        ...
        chunkingJob.setOutputFormatClass(MapFileOutputFormat.class);
		...
		if (exitcode == 1) {
        	...
        	SequenceFileInputFormat.addInputPath(expandingJob, new Path(output, "indexer/part-r-00000"));
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new HadoopDetector_modified(), args);
